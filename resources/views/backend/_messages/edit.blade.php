            ...
            {!! Form::model($message, ['route' => ['admin.messages.update', $message->id], 'method'=>'PUT', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group recipient-list hidden">
                            ...
                            <div class="col-lg-10">
                                {{ Form::text('recipients', $recipients, ['class' => '', 'id' => 'recipients', 'autocomplete' => 'off']) }}
                            </div><!--col-lg-10-->
                        </div><!--form control-->
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="pull-right">
                            {{ Form::submit(trans('buttons.general.crud.update'), ['class' => 'btn btn-success btn-md', $message->sent ? 'disabled':''] ) }}
                        </div><!--pull-right-->
