            ...
            <div class="row">
				...
				<div class="col-md-9">
					<div class="tab-content">
						<div id="profile" class="panel panel-primary tab-pane active">
							@include('frontend.user.account.profile._profile')
						</div>
						<div id="edit-profile" class="panel panel-primary tab-pane">
							@include('frontend.user.account.profile._edit')
						</div>
						<div id="change-password" class="panel panel-primary tab-pane">
							@include('frontend.user.account.profile._change-password')
						</div>
						<div id="preferences" class="panel panel-primary tab-pane">
							@include('frontend.user.account.profile._preferences')
						</div>
					</div>
				</div>
