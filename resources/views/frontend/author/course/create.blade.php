                    ...
                    <div class="content">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h5>{{trans('strings.frontend.create-course')}}</h5>
                            </div>
                        
                            <div class="panel panel-body">
                                {!! Form::open(array('action' => 'Frontend\Author\CourseController@store', 'class' => 'form-horizontal create-course', 'method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data')) !!}
    						        {{ csrf_field() }}
    						        
    						        <div class="form-group has-feedback {{ $errors->has('title') ? ' has-error ' : '' }}">
            							<label class="col-lg-2 col-md-2 label-right">{{trans('strings.frontend.course-title')}}: </label>
            							<div class="col-lg-8">
