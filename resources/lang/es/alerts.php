    ...
    */
    ...
    'frontend' => [
        'general' => [
            ...
            'delete-confirm-text' => "¡Esta sección será eliminada permanentemente con todas sus lecciones!",
            'yes-delete' => "Sí, eliminar.",
            "cancel" => "Cancelar",
            "wrong-price" => "Parece que ha enviado un precio equivocado con la solicitud de compra. Transacción negada."
        ]   
