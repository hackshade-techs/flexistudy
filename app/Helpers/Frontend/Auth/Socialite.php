...
class Socialite
{
    ...
    public function getSocialLinks()
    {
        ...
        if (strlen(getenv('BITBUCKET_CLIENT_ID'))) {
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'bitbucket']) .'"><i class="fa fa-bitbucket"></i></a></li>';
        ...
        if (strlen(getenv('FACEBOOK_CLIENT_ID'))) {
            ...
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'facebook']) .'"><i class="fa fa-facebook"></i></a></li>';
        ...
        if (strlen(getenv('GOOGLE_CLIENT_ID'))) {
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'google']) .'"><i class="fa fa-google"></i></a></li>';
        ...
        if (strlen(getenv('GITHUB_CLIENT_ID'))) {
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'github']) .'"><i class="fa fa-github"></i></a></li>';
        ...
        if (strlen(getenv('LINKEDIN_CLIENT_ID'))) {
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'linkedin']) .'"><i class="fa fa-linkedin"></i></a></li>';
        ...
        if (strlen(getenv('TWITTER_CLIENT_ID'))) {
            $socialite_enable[] = '<li><a href="'. route('frontend.auth.social.login',['provider' => 'twitter']) .'"><i class="fa fa-twitter"></i></a></li>';
